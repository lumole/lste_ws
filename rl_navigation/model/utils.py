...
def get_init_pose(index):
    init_pose_list = [[-7.00, 11.50, np.pi], [-7.00, 9.50, np.pi], [-18.00, 11.50, 0.00], [-18.00, 9.50, 0.00],
                      [-12.50, 17.00, np.pi*3/2], [-12.50, 4.00, np.pi*1/2], [-2.00, 16.00, -np.pi/2], [0.00, 16.00, -np.pi/2],
                      ...
                      [-9.40, -15.00, np.pi*3/2], [-9.40, -11.47, np.pi*3/2], [-11.65, -4.49, np.pi], [-15.35, -4.49, np.pi],
                      [-18.35, -6.47, np.pi/2], [-18.35, -10.00, np.pi/2], [-18.35, -13.53, np.pi/2], [-13.85, -18.21,0.00],
                      [-10.15, -18.21, 0.00], [-8.20, -13.53, np.pi/2], [10.00, -17.00, -np.pi/2], [12.00, -17.00, -np.pi/2],
...
def rl_get_init_pose(index):
    init_pose_list = [[-3.50, 0.50, 0.00], [-3.50, -0.50, 0.00], [3.50, 0.50, np.pi], [3.50, -0.50, np.pi],
                      [0.50, 3.50, np.pi*3/2], [-0.50, 3.50, np.pi*3/2], [0.50, -3.50, np.pi/2], [-0.50, -3.50, np.pi/2],
                      [3.00, 16.00, -np.pi/2], [5.00, 16.00, -np.pi/2], [10.00, 4.00, np.pi/2], [12.00, 4.00, np.pi/2],
                      [14.00, 4.00, np.pi/2], [16.00, 4.00, np.pi/2], [18.00, 4.00, np.pi/2], [-2.5, -2.5, 0.00],
                      [-0.5, -2.5, 0.00], [3.5, -2.5, np.pi], [5.5, -2.5, np.pi], [-2.5, -18.5, np.pi/2],
                      [-0.5, -18.5, np.pi/2], [1.5, -18.5, np.pi/2], [3.5, -18.5, np.pi/2], [5.5, -18.5, np.pi/2],
...
def get_goal_point(index):
    goal_list = [[-18.0, 11.5], [-18.0, 9.5], [-7.0, 11.5], [-7.0, 9.5], [-12.5, 4.0], [-12.5, 17.0],
                 ...
                 [-13.85, -18.21], [-10.15, -18.23], [-18.15, -10.21], [-18.15, -13.21], [-8.15, -2.53], [-11.50, -2.50],
                 [-15.20, -2.21], [-18.35, -6.50], [-18.35, -9.50], [-18.15, -18.21],
                 ]
    return goal_list[index]


def rl_get_goal_point(index):
    goal_list = [[3.50, 0.50], [3.50, -0.50], [-3.50, 0.50], [-3.50, -0.50], [0.50, -3.50], [-0.50, -3.50],
                 [0.50, 3.50], [-0.50, 3.50], [3.0, 3.0], [5.0, 3.0], [10.0, 10.0], [12.0, 10.0],
                 [14.0, 10.0], [16.0, 10.0], [18.0, 10.0], [3.5, -2.5], [5.5, -2.5], [-2.5, -2.5],
                 [-0.5, -2.5], [-2.5, -5.5], [-0.5, -5.5], [1.5, -5.5], [3.5, -5.5], [5.5, -5.5],
                 [-13.85, -18.21], [-10.15, -18.23], [-18.15, -10.21], [-18.15, -13.21], [-8.15, -2.53], [-11.50, -2.50],
                 [-15.20, -2.21], [-18.35, -6.50], [-18.35, -9.50], [-18.15, -18.21],
...
def sac_get_goal_point(index):
    goal_list = [[-18.0, 11.5], [-18.0, 9.5], [-7.0, 11.5], [-7.0, 9.5], [-12.5, 4.0], [-12.5, 17.0],
                 [-2.0, 3.0], [0.0, 3.0], [3.0, 3.0], [5.0, 3.0], [10.0, 10.0], [12.0, 10.0],
                 [14.0, 10.0], [16.0, 10.0], [18.0, 10.0], [-2.5, -5.5], [-0.5, -5.5], [1.5, -5.5], [3.5, -5.5], [5.5, -5.5],
                 [-13.85, -18.21], [-10.15, -18.23], [-18.15, -10.21], [-18.15, -13.21], [-8.15, -2.53], [-11.50, -2.50],
                 [-15.20, -2.21], [-18.35, -6.50], [-18.35, -9.50], [-18.15, -18.21],
                 ]
    return goal_list[index]

def sac_get_init_pose(index):
    init_pose_list = [[-7.00, 11.50, np.pi], [-7.00, 9.50, np.pi], [-18.00, 11.50, 0.00], [-18.00, 9.50, 0.00],
                      [-12.50, 17.00, np.pi*3/2], [-12.50, 4.00, np.pi*1/2], [-2.00, 16.00, -np.pi/2], [0.00, 16.00, -np.pi/2],
                      [3.00, 16.00, -np.pi/2], [5.00, 16.00, -np.pi/2], [10.00, 4.00, np.pi/2], [12.00, 4.00, np.pi/2],
                      [14.00, 4.00, np.pi/2], [16.00, 4.00, np.pi/2], [18.00, 4.00, np.pi/2], [-2.5, -18.5, np.pi/2],
                      [-0.5, -18.5, np.pi/2], [1.5, -18.5, np.pi/2], [3.5, -18.5, np.pi/2], [5.5, -18.5, np.pi/2],
                      [-9.40, -15.00, np.pi*3/2], [-9.40, -11.47, np.pi*3/2], [-11.65, -4.49, np.pi], [-15.35, -4.49, np.pi],
                      [-18.35, -6.47, np.pi/2], [-18.35, -10.00, np.pi/2], [-18.35, -13.53, np.pi/2], [-13.85, -18.21,0.00],
                      [-10.15, -18.21, 0.00], [-8.20, -13.53, np.pi/2], [10.00, -17.00, -np.pi/2], [12.00, -17.00, -np.pi/2],
